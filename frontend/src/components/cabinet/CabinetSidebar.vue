...
const roleLinks = computed<SidebarLink[]>(() => {
    ...
    if (auth.hasRole("author")) {
        links.push(
            {
                to: "/cabinet/author/articles",
                label: t("cabinet.nav.myArticles"),
            },
            {
                to: "/cabinet/author/submit",
                label: t("cabinet.nav.submitArticle"),
            },
        );
    }
    if (auth.hasRole("reviewer")) {
        links.push(
            {
                to: "/cabinet/reviewer/articles",
                label: t("cabinet.nav.reviewArticles"),
            },
            {
                to: "/cabinet/reviewer/invitations",
                label: t("cabinet.nav.invitations"),
            },
        );
    }
    if (auth.hasRole("chief_editor")) {
        links.push(
            {
                to: "/cabinet/chief-editor/articles",
                label: t("cabinet.nav.manageArticles"),
            },
            {
                to: "/cabinet/chief-editor/invitations",
                label: t("cabinet.nav.invitations"),
            },
            {
                to: "/cabinet/chief-editor/decisions",
                label: t("cabinet.nav.decisions"),
            },
        );
    }
