...
async function handleSubmit() {
    ...
    if (mode.value === "reject") {
        ...
        try {
            await articlesApi.topicCheck(props.articleId, {
                approved: false,
...
<template>
    <div class="topic-check-form">
                ...
                <li v-for="candidate in candidates" :key="candidate.id">
                    <label>
                        <input
                            type="checkbox"
                            :checked="
                                selectedReviewerIds.includes(candidate.id)
                            "
        ...
        <p v-if="fieldError" class="topic-check-form__error" role="alert">
            {{ fieldError }}
        </p>
        <p v-if="formError" class="topic-check-form__error" role="alert">
            {{ formError }}
        </p>
