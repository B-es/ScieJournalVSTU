"""
Django settings for the ScieJournalVSTU backend.

See TS section 2 (technology stack) and section 12 (security) for the
...
# Database
# TS section 2: PostgreSQL in production, SQLite substitute for local dev.
...
# Localization — RU/EN per PRD section 6.
LANGUAGE_CODE = "ru"
...
# --- REST framework / JWT (TS section 8) ---
REST_FRAMEWORK = {
...
# --- CORS (Nuxt3 dev server -> Django API) ---
